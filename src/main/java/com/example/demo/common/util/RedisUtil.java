...
public class RedisUtil {
     ...
     * @return 对应的多个键值
     */
    public <T> Map<Object, T> hmget(String key) {
     ...
     * @param item 项
     * @param by 要增加几(大于0)
     * @return double 返回新增后的值
     * @author LiBo
     * @date 2023-03-08 11:49
     * */
     ...
     * @param item 项
     * @param by 要减少几(小于0)
     * @return double 返回减少后的值
     * @author LiBo
     * @date 2023-03-08 11:50
     * */
