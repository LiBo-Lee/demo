...
public class EmployeeInfController {
    ...
    @SaCheckPermission(value = "employee:view")
    ...
    @SaCheckPermission(value = "employe:add")
    ...
    @SaCheckPermission(value = "employee:delete")
    ...
    @SaCheckPermission(value = "employee:update")
